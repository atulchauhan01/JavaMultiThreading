 ...
 * alternative to synchronized code blocks. <br>
 * {@link java.util.concurrent.locks.ReentrantLock}s let you do all the stuff
 * that you can do with {@code synchronized}, {@link Object#wait()} and
 * {@link Object#notify()}, plus some more stuff. Besides that may come in handy
 ...
 * include: <br>
 * <ul>
 * <li>The ability to have more than one
 * {@link java.util.concurrent.locks.Condition} variable per monitor.</li>
 ...
 * {@link Object#wait()}/{@link Object#notify()} queue.</li>
 * <li>The ability to make the lock "fair". <em> "[fair] locks favor granting
 * access to the longest-waiting thread. Otherwise this lock does not guarantee
 * any particular access order." </em></li>
